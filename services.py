# services.py
from database import collection_user, collection_add_vacancy, collection_bills, collection_new_candidate, fs
from models import User, add_vacancy, Bills, Candidate, UpdateVacancyStatus, UpdateCandidateStatus
